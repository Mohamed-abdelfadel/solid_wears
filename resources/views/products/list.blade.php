...
<div class="mx-5">
    <div class="row">
        <h1 class="fs-2 mt-4">Products List ⇒ {{$products->total()}}</h1>
        <hr>
        ...
        <table class="table table-hover table-sm table-light  shadow  ">
            <thead class="table-primary ">
                <th style="  width: 1%;" class="fw-bolder" >#</th>
            ...
            <tbody>
              ...
              <tr valign='middle' >
                  <td><a href="{{route('products.purchase', $product->id)}}" class="btn btn-success">Buy</a></td>
                  <td >{{$product->id}}</td>
        ...
        <div class="row">
        <a href="{{route('products.create')}}" class=" btn btn-outline-success col-2 m-2">Add new product</a>
        </div>
        <div class="row">
        <a href="{{route('products.cart')}}" class="btn btn-outline-secondary col-2 m-2">Cart</a>
        </div>
