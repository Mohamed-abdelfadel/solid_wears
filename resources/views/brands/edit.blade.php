    ...
    <div class="mx-5">
        <div class="row">
            <div class="col-6">
                ...
                <hr>
                <div class="row">
                <form class="col-6" action="{{route('brands.update' ,  $brand->id )}}" method="post">
                    @csrf
                    @method('PUT')
                        <div class="form-floating mb-4 ">
                            <input type="text" class="form-control   @error('name') is-invalid @enderror " name="name" id='name' placeholder="name" value="{{ old('name',$brand->name) }}">
                        ...
                        <a href="{{route('brands.list')}}" class="btn btn-outline-primary px-4">Customers list</a>
                </form>
